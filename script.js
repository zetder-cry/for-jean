$(document).ready(function () {
    ...
    var content = [{
       ...
       title: "",
       desc: "expressing feelings is a pretty serious thing, a lot will be sacrificed including the end result of releasing things that have been stored for some time, but ill be honest is quite a relief and not an easy thing. Here I just want to express my feelings for you, the problem is accepted or not it depends on you, I also won't expect more really."
    }, {
        title: "",
        desc: "If you  uncomfortable just say, \"balik saja sana ke zeta\", if you already have a boyfriend, sorry... maybe that's all from me, hehe thanks for reading.feel"
    }, {
        title: "jangan pernah merasa terbebani oleh rasa suka saya ya",
